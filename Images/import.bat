...
..\pop2beeb\pop2beeb -i IMG.BGTAB2.DUN.bin -o BEEB.IMG.BGTAB2.DUN.bin -b IMG.BGTAB2.DUN.bin.john.png -pal 0

..\pop2beeb\pop2beeb -i IMG.BGTAB1.DUN.bin -s 1 -e 87 -o BEEB.IMG.BGTAB1.DUNA.bin -b IMG.BGTAB1.DUN.bin.john.png -pal 0
..\pop2beeb\pop2beeb -i IMG.BGTAB1.DUN.bin -s 88 -e 111 -o BEEB.IMG.BGTAB1.DUNB.bin -b IMG.BGTAB1.DUN.bin.john.png -pal 0

REM ..\pop2beeb\pop2beeb -i IMG.BGTAB1.PAL.bin -o BEEB.IMG.BGTAB1.PAL.bin -b IMG.BGTAB1.PAL.bin.mode5.png -pal 0
REM ..\pop2beeb\pop2beeb -i IMG.BGTAB2.PAL.bin -o BEEB.IMG.BGTAB2.PAL.bin -b IMG.BGTAB2.PAL.bin.mode5.png -pal 0

REM ..\pop2beeb\pop2beeb -i IMG.BGTAB1.PAL.bin -s 1 -e 87 -o BEEB.IMG.BGTAB1.PALA.bin -b IMG.BGTAB1.PAL.bin.mode5.png -pal 0
REM ..\pop2beeb\pop2beeb -i IMG.BGTAB1.PAL.bin -s 88 -e 111 -o BEEB.IMG.BGTAB1.PALB.bin -b IMG.BGTAB1.PAL.bin.mode5.png -pal 0
