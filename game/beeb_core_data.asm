...
.palette_table
{
    ...
    EQUB 0, MODE2_RED_PAIR, MODE2_CYAN_PAIR, MODE2_WHITE_PAIR           ; RCW
    EQUB 0, MODE2_YELLOW_PAIR, MODE2_CYAN_PAIR, MODE2_WHITE_PAIR        ; YCW

    EQUB 0, MODE2_RED_PAIR, MODE2_YELLOW_PAIR, MODE2_MAGENTA_PAIR       ; RYM
